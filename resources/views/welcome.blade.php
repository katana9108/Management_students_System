...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <form class="d-flex" role="search">
                        <input class="form-control me-2" type="search" placeholder="Search student" aria-label="Search" value="">
            ...
            <div class="row">
                <div class="col-md-8 bg-info ">
                    <table class="table table-striped">
                        <div class="container mb-5 pt-5  bg-secondary w-100">
                ...
                <div class="col-md-4  bg-warning">
                    ...
                    <form action="{{route('students.store')}}" class="form-horizontal mt-3" method='post'>
                        ...
                        <div class="form-group ">
                            ...
                            <input type="text" name="first_name" id="first_name" class="form-control" placeholder="First Name" required focus>
                        </div>

                        <div class="form-group">
                            <label for="last_name">Last Name</label>
                            <input type="text" name="last_name" id="last_name" class="form-control" placeholder="Last Name" required focus>
                        </div>

                        <div class="form-group">
                            <label for="email">Email</label>
                            <input type="email" name="email" id="email" class="form-control" placeholder="Email" required focus>
                        </div>

                        <div class="form-group">
                            <label for="cne">CNE</label>
                            <input type="text" name="cne" id="cne" class="form-control" placeholder="CNE" required focus>
                        </div>

                        <div class="form-group">
                            <label for="age">Birth year</label>
                            <input type="text" name="age" id="age" class="form-control" placeholder="year of birth " required focus>
                            {{-- <input type="hidden" name="user_id" value="{{$users->id}}"> --}}
                        </div>

                        <div class="form-group">
                            <label for="formation">Formation</label>
                            <input type="text" name="formation" id="formation" class="form-control" placeholder="Formation " required focus>
                        </div>
    ...
    <footer class="footer w-100  h-100 py-5 bg-secondary">
        <div class="container text-center">
            <span class="text-white">
                MANAGEMENT STUDENT SCHOOL
            </span>
        </div>
